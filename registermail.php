...
if (isset($_POST['submit'])) {
    ...
    if (empty($contact)) {
        ...
        if ($sql_num > 0) {
            ...
            $insert = "INSERT INTO admin_users(`userfullname` , `user_email` ,`user_password` ,`user_type` ,`user_contact` ,`token`,`is_verified` , `registered_on` )
            VALUES('$name' , '$email', '$pass_hach', '$user_type', '$contact' , '$token' , 'inactive' , NOW())";
