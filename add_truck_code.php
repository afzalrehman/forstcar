...
if (isset($_POST['add_truck_btn'])) {
    ...
    // if (
    //     empty($make) || empty($model) || empty($wheelbase) || empty($vin) || empty($contact_Name) ||
    ...
    if ($check_model > 0) {
        ...
        `part`, `eutectic_Plate`, `expansion_Valve`, `recovery_Tank`, `pressure_Control`, `sight_Glass`, `filter_Drier`, `thermostat`, `misc`, 
        `added_on`, `added_by`)
        ...
        '$pressure_Control', '$sight_Glass', '$filter_Drier', '$thermostat', '$misc', NOW(),'Amin')";
